...
namespace Michsky.UI.ModernUIPack
{
    public class MUIPEditor : MonoBehaviour
    {
        ...
        static void DRPOD()
        {
            GameObject clone = Instantiate(Resources.Load<GameObject>("Dropdowns/Outline Dropdown"), Vector3.zero, Quaternion.identity) as GameObject;
			clone.transform.SetParent (GameObject.Find("Canvas").transform, false);
			clone.name = clone.name.Replace("(Clone)","").Trim();
        }
        ...
        static void PBLCA()
        {
            GameObject clone = Instantiate(Resources.Load<GameObject>("Progress Bars (Loop)/Circle Arround"), Vector3.zero, Quaternion.identity) as GameObject;
			clone.transform.SetParent (GameObject.Find("Canvas").transform, false);
			clone.name = clone.name.Replace("(Clone)","").Trim();
        }
        ...
        static void PBLSFIN()
        {
            GameObject clone = Instantiate(Resources.Load<GameObject>("Progress Bars (Loop)/Standard Finish"), Vector3.zero, Quaternion.identity) as GameObject;
			clone.transform.SetParent (GameObject.Find("Canvas").transform, false);
			clone.name = clone.name.Replace("(Clone)","").Trim();
        }
